...
use Algoritma\BehatExtension\Element\AlgoritmaForm;
use Algoritma\BehatExtension\Element\AlgoritmaPageObjectAware;
use Algoritma\BehatExtension\Element\RouterAwareInterface;
 ...
 */
class AlgoritmaMainContext extends MinkContext implements
    AlgoritmaPageObjectAware,
    ...
    AppKernelAwareInterface
{
    ...
    public function beforeStep(BeforeStepScope $scope)
    {
        ...
        /** @var AlgoritmaSelenium2Driver $driver */
    ...
    public function iCloseAllFlashMessages($flashMessageElement = 'Flash Message', $timeLimit = 30)
    {
        $flashMessages = $this->spin(
            function (AlgoritmaMainContext $context) use ($flashMessageElement) {
    ...
    {
        $flashMessages = $this->spin(function (AlgoritmaMainContext $context) use ($flashMessageElement) {
            return $context->findAllElements($flashMessageElement);
        }, $timeLimit);
    ...
    {
        return $this->spin(
            function (AlgoritmaMainContext $context) use ($title, $flashMessageElement) {
    ...
    {
        $result = $this->spin(function (AlgoritmaMainContext $context) use ($text) {
    ...
    public function iAmOnDashboard()
    {
        ...
        $this->visit($router->generate('algoritma_default'));
    }
     ...
     * @see \Algoritma\Bundle\TestFrameworkBundle\Tests\Behat\Context\AlgoritmaMainContext::switchToActorWindowSession
     *
...
JS;
    ...
    public function openPage($pageName)
    {
        ...
        if ($page instanceof RouterAwareInterface) {
            $page->setRouter($this->getAppContainer()->get('router'));
        }
    ...
    public function selectOption($select, $option)
    {
        ...
        $this->createAlgoritmaForm()->selectFieldOption($select, $option);
    }
    ...
    public function fillField($field, $value)
    {
        ...
        $value = $this->fixStepArgument($value);
        $value = $this->createAlgoritmaForm()->normalizeValue($value);
        ...
        $this->createAlgoritmaForm()->fillField($field, $value);
    }
    ...
    {
        $isVisible = $this->spin(function (AlgoritmaMainContext $context) use ($element) {
    ...
    public function removeCollectionElement($collectionFieldName, $rowNumber)
    {
        ...
        $collection = $this->createAlgoritmaForm()->findField($collectionFieldName);
     ...
     * @see \Algoritma\Bundle\TestFrameworkBundle\Tests\Behat\Context\AlgoritmaMainContext::sessionsInit
     * @see \Algoritma\Bundle\TestFrameworkBundle\Tests\Behat\Context\AlgoritmaMainContext::loginAsUserWithPasswordInSession
     ...
     *
     * @see \Algoritma\Bundle\TestFrameworkBundle\Tests\Behat\Context\AlgoritmaMainContext::iOperateAsActorUnderSession
     */
