...
use Algoritma\BehatExtension\Context\AssertTrait;
use Algoritma\BehatExtension\Context\SpinTrait;
 ...
 *
 * @method AlgoritmaSelenium2Driver getDriver()
 */
class Element extends NodeElement
{
    ...
    public function __construct(
        Session $session,
        AlgoritmaElementFactory $elementFactory,
